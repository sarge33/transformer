...
from config import get_translate_config, latest_weights_file_path 
...
def translate(sentence: str, epoch='10'):
    ...
    model_filename = latest_weights_file_path(config, epoch)
